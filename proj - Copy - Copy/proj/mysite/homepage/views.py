...
def menu_view(request):
    ...
    if request.method == 'POST':
        ...
        i = i + str(1)
        while(flag):
            texttospeech("To access  your email say email. To check maps say direction. To book taxi say taxi .Do you want me to repeat?", file + i)
            i = i + str(1)
            say = speechtotext(3)
            if say == 'No' or say == 'no':
                flag = False
...
def map_view(request):
    ...
    if request.method == 'POST':
        ...
        if ans == 'search':
            ...
            return JsonResponse({'result' : 'direction'})           
        else:
            texttospeech("Invalid action. Please try again.", file + i)
            i = i + str(1)
            return JsonResponse({'result': 'failure'})
    ...
    if request.method == 'POST':
        ...
        while (flag):
            ...
            if daddr != 'N':
                ...
                i = i + str(1)
                say = speechtotext(3)
                if say == 'yes' or say == 'Yes' or say == 's':
                    flag = False
            else:
                texttospeech("could not understand what you meant:", file + i)
                i = i + str(1) 
        ...
        while (flag): 
            ...
            while (otpFLag):
                ...
                otp = speechtotext(11) 
                if otp != 'N':
                    texttospeech("You meant " + otp + " say yes to confirm otp or no to enter again", file + i)
                    i = i + str(1)
                    say = speechtotext(3)
                    if say == 'yes' or say == 'Yes' or say =='s':
                        otpFLag = False
